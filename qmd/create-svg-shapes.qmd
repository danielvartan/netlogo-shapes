...
This document generates SVG files for each turtle shape found in a NetLogo XML file (`.nlogox`). Each shape is extracted and saved in a designated directory.
