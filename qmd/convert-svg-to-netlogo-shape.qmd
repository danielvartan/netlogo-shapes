...
This document converts a SVG file into a [NetLogo](https://www.netlogo.org/) [XML](https://en.wikipedia.org/wiki/XML) shape (`.nlogox`).
...
#' @param output_dir Directory to save the XML file.
...
## Create NetLogo XML Shape

```{r}
svg_file |> convert_svg_to_netlogo()
```
